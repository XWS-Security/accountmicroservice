...
public class UpdateUserInMessagingMicroserviceWorkflowStep implements WorkflowStep {
    ...
    public UpdateUserInMessagingMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUpdateUserDto oldUser,
