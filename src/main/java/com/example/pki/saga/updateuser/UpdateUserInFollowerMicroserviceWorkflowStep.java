...
public class UpdateUserInFollowerMicroserviceWorkflowStep implements WorkflowStep {
    ...
    public UpdateUserInFollowerMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUpdateUserDto oldUser,
