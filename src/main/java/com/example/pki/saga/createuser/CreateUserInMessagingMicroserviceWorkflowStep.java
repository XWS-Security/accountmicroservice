...
public class CreateUserInMessagingMicroserviceWorkflowStep implements WorkflowStep {
    private final WebClient webClient;
    private final FollowerMicroserviceUserDto userDto;
    private WorkflowStepStatus status = WorkflowStepStatus.PENDING;

    public CreateUserInMessagingMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUserDto userDto) {
