...
public class CreateAgentInCampaignMicroserviceWorkflowStep implements WorkflowStep {
    private final WebClient webClient;
    private final FollowerMicroserviceUserDto userDto;
    private WorkflowStepStatus status = WorkflowStepStatus.PENDING;

    public CreateAgentInCampaignMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUserDto userDto) {
