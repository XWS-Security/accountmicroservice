...
public class CreateUserInCampaignMicroserviceWorkflowStep implements WorkflowStep {
    private final WebClient webClient;
    private final FollowerMicroserviceUserDto userDto;
    private WorkflowStepStatus status = WorkflowStepStatus.PENDING;

    public CreateUserInCampaignMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUserDto userDto) {
