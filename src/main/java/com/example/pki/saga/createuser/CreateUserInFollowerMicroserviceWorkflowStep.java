...
public class CreateUserInFollowerMicroserviceWorkflowStep implements WorkflowStep {
    private final WebClient webClient;
    private final FollowerMicroserviceUserDto userDto;
    private WorkflowStepStatus status = WorkflowStepStatus.PENDING;

    public CreateUserInFollowerMicroserviceWorkflowStep(WebClient webClient, FollowerMicroserviceUserDto userDto) {
